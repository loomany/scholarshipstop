  ...
  return (
    <article className="mx-auto max-w-[52rem] px-6 py-16 sm:py-20">
      ...
      <header className="border-b border-zinc-200 pb-10">
        ...
        <p className="mt-3 text-sm text-zinc-500">Last updated: April 2, 2026</p>
      </header>

      <div className="pt-10">
        <p className="text-base leading-relaxed text-zinc-700">
          These Terms of Use govern your access to and use of ScholarshipTop and
        ...
        <section className={sectionClass} aria-labelledby="t1">
          ...
          <p className={pClass}>
            ...
            recommendations, and related tools to help users discover scholarship
            opportunities.
          </p>
          <p className={pClass}>
        ...
        <section className={sectionClass} aria-labelledby="t5">
          ...
          <p className={pClass}>
            ...
            guarantee that all information is complete, accurate, or up to date at
            all times.
          </p>
          <p className={pClass}>
        ...
        <section className={sectionClass} aria-labelledby="t7">
          ...
          <p className={pClass}>
            ScholarshipTop may offer paid features, subscriptions, or access to
            premium tools. Access to such features may depend on payment and
            account status.
          </p>
          <p className={pClass}>
            If paid plans are introduced or updated, additional billing terms may
            apply.
          </p>
        </section>
        ...
        <p className={`${pClass} mt-14 border-t border-zinc-200 pt-10 text-zinc-800`}>
          By using ScholarshipTop, you agree to these Terms of Use.
        </p>
