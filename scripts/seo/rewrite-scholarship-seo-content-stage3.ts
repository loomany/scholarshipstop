...
function replacementForBadSentence(
  sentence: string,
  fieldPath: string
): string {
  ...
  if (
    /guarantee|final decision|not responsible|not affiliated|not official/.test(
      lower
    )
  ) {
  ...
  if (
    /official|provider|sponsor|apply|application|submit|shortlist/.test(lower)
  ) {
...
function applyPhraseLevelRewrites(text: string): string {
  return text
    ...
    .replace(
      /\bofficial provider application paths\b/gi,
      'provider application paths'
    )
    .replace(
      /\bofficial provider application path\b/gi,
    ...
    .replace(
      /\bofficial eligibility details\b/gi,
      'eligibility signals and provider-path context'
    )
    .replace(
      /\bofficial eligibility detail\b/gi,
      'eligibility signal and provider-path context'
    )
    ...
    .replace(
      /\bofficial scholarship websites\b/gi,
      'provider application paths'
    )
    ...
    .replace(
      /\bofficial scholarship descriptions\b/gi,
      'structured listing descriptions'
    )
    .replace(
      /\bofficial scholarship description\b/gi,
    ...
    .replace(
      ...
      'ScholarshipTop shows requirement details as part of application planning'
    )
    .replace(
      /\bdetails can change\b/gi,
      'ScholarshipTop shows available details as part of application planning'
    )
    .replace(
    ...
    .replace(
      /\bconfirm that international students are eligible\b/gi,
      'compare international-student eligibility signals'
    )
    .replace(
    ...
    .replace(
      ...
      'ScholarshipTop shows provider-path context so you can compare what is currently offered'
    )
    .replace(
      ...
      'ScholarshipTop shows provider-path context so you can understand need-based eligibility signals, audience fit, and required materials'
    )
    .replace(
      /\bprovider application paths are the place to confirm the current terms\b/gi,
      'ScholarshipTop shows provider-path context so you can plan around current terms'
    )
    .replace(
      /\bprovider application paths are the place to confirm\b/gi,
      'ScholarshipTop shows provider-path context to compare'
    )
    .replace(
    ...
    .replace(
      /\bsource named on that row\b/gi,
      'provider application path shown on that row'
    )
    .replace(
      /\bprovider or school page\b/gi,
      'provider-path context in ScholarshipTop'
    )
    .replace(
    ...
    .replace(
      /\bprovider-path context for final confirmation\b/gi,
      'provider-path context for application planning'
    )
    .replace(
      /\bcatalog for discovery\b/gi,
      'ScholarshipTop workspace for comparison'
    )
    .replace(/\bfinal confirmation\b/gi, 'application planning')
    .replace(
      /\bconfirmed row by row\b/gi,
      'compared row by row in ScholarshipTop'
    )
    .replace(
      /\bopening provider application paths to review current details\b/gi,
      'using provider-path context in ScholarshipTop to review current details'
    )
    .replace(
      /\bopen provider application paths to review current details\b/gi,
      'use provider-path context in ScholarshipTop to review current details'
    )
    .replace(
      /\bprovider application paths to review current details\b/gi,
      'provider-path context in ScholarshipTop for current details'
    )
    .replace(
      /\bshould always be structured on the provider application path\b/gi,
      'can be planned with provider-path context in ScholarshipTop'
    )
    ...
    .replace(
      /\bopen the provider-path context\b/gi,
      'review provider-path context in ScholarshipTop'
    )
    .replace(
    ...
    .replace(
      ...
      'ScholarshipTop shows provider-path context so you can plan your next step before you apply'
    )
    .replace(
    ...
    .replace(
      /\breview fit on the provider-path context\b/gi,
      'review fit and provider-path context in ScholarshipTop'
    )
    .replace(
    ...
    .replace(
      /\bverify every detail\b/gi,
      'review eligibility signals and provider-path context'
    )
    .replace(
      /\bdouble-check every detail\b/gi,
      'review eligibility signals and provider-path context'
    )
    .replace(/\balways verify\b/gi, 'review')
    .replace(
      /\bindependently verify\b/gi,
      'review in your ScholarshipTop workspace'
    )
    .replace(
      /\bafter verifying each listing\b/gi,
      'after reviewing organized details and provider-path context'
    )
    .replace(
      /\bafter verifying eligibility and award terms\b/gi,
      'after reviewing eligibility signals and award details in ScholarshipTop'
    )
    .replace(
      /\bwhile still verifying each row\b/gi,
      'while using ScholarshipTop to compare each row'
    )
    .replace(
      /\bverifying each provider application path\b/gi,
      'reviewing provider-path context in ScholarshipTop'
    )
    .replace(
      /\bverifying the latest terms on the provider application path\b/gi,
      'using structured provider-path context to plan your next step'
    )
    ...
    .replace(
      /\brather than a guarantee\b/gi,
      'as part of your ScholarshipTop workspace'
    )
    .replace(
      /\bnot a guarantee for every program\b/gi,
      'a planning signal for comparing programs'
    )
    ...
    .replace(
      /\bcheck the provider-path context\b/gi,
      'review provider-path context in ScholarshipTop'
    )
    .replace(
      /\bcheck provider-path context\b/gi,
      'review provider-path context in ScholarshipTop'
    )
    .replace(
      /\bcheck the provider application path\b/gi,
      'review the provider application path in ScholarshipTop'
    )
    .replace(
      /\bcheck provider application path\b/gi,
      'review the provider application path in ScholarshipTop'
    )
    .replace(/\bstarting point only\b/gi, 'application workspace')
    .replace(
      /\btreat this as a starting point\b/gi,
      'use this as an organized ScholarshipTop workspace'
    )
    ...
    .replace(
      /\bdiscovery only\b/gi,
      'search and application planning workspace'
    )
    ...
    .replace(
      /\bnot an official scholarship provider\b/gi,
      'a scholarship search and application workspace'
    )
    .replace(/\bscholarship provider\b/gi, 'relevant provider')
    .replace(
      /\bprovider is responsible\b/gi,
      'the relevant provider makes final decisions'
    )
    .replace(
      /\binformation may be outdated\b/gi,
      'ScholarshipTop highlights available details in a structured format'
    )
    .replace(
      /\bterms may change\b/gi,
      'details can be planned from structured provider-path context'
    )
    .replace(
      /\bdeadlines may change\b/gi,
      'deadline context is organized for planning'
    )
    .replace(
      /\baward amounts may change\b/gi,
      'award details are organized for planning'
    )
    .replace(
      /\buse at your own risk\b/gi,
      'use ScholarshipTop to compare and plan with more context'
    );
}
...
function main() {
  ...
  console.log(
    `Mode: ${sample ? 'sample' : 'full'} ${write ? 'write' : 'dry-run'}`
  );
  ...
  if (allChanges.length > 0) {
    ...
    for (const change of allChanges.slice(0, 8)) {
      ...
      console.log(
        `  before: ${change.before.slice(0, 180).replace(/\s+/g, ' ')}`
      );
      console.log(
        `  after:  ${change.after.slice(0, 180).replace(/\s+/g, ' ')}`
      );
    }
  }
}
