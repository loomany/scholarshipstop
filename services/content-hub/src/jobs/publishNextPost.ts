...
const STATUS_PRIORITY: Array<"review_needed" | "draft"> = ["review_needed", "draft"];

async function findCandidateByStatus(status: "review_needed" | "draft"): Promise<PublishCandidate | null> {
  ...
  return (data as PublishCandidate | null) ?? null;
}

async function findPublishCandidate(): Promise<PublishCandidate | null> {
