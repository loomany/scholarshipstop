...
import type { RelatedArticle, RelatedArticleLink } from "./types.js";
...
export async function verifyRelatedArticleLinks(links: RelatedArticleLink[], articleSlug: string): Promise<RelatedArticleLink[]> {
...
export function buildRelatedArticlePath(slug: string): string {
