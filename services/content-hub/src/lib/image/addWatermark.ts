...
async function estimateBrightness(inputBuffer: Buffer): Promise<number> {
...
function createWatermarkSvg(width: number, height: number, text: string, brightness: number): string {
