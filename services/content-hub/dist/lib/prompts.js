...
function buildStructureInstructions(articleType) {
...
export function buildImagePrompt(topic, options) {
...
export function buildShortArticleExpansionPrompt(bodyMarkdown, currentCount, minWords) {
